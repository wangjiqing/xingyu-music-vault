...
## v0.8.x — 歌手/专辑浏览（v0.8.1 / v0.8.3）

> 阶段目标：按歌手、专辑维度聚合歌曲，提供音乐内容视角浏览。

- [ ] v0.8.1：歌手浏览视图（按歌手聚合，展示歌手名、歌曲数量、代表封面）
- [ ] v0.8.3：专辑浏览视图（按专辑聚合，展示封面、年份、曲目列表）
- [ ] 歌手/专辑详情页

**本阶段不包含**：播放器、在线播放流、AI 推荐、歌词对齐。
