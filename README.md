...
v1.1.3 已补充 OpenAPI AK/SK 凭证管理与 HMAC-SHA256 签名认证。管理端继续使用账号密码 + Session Cookie；OpenAPI 客户端使用独立 Access Key / Secret Key，不再接受旧静态 OpenAPI Token。部署前请先阅读 [部署安全边界](docs/deployment.md#部署安全边界)。
...
- [Release Notes](docs/release/v1.1.3-release-notes.md)
