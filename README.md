...
后续 v1.1.x 将逐步补齐管理员初始化、登录认证、OpenAPI Token、反向代理与 HTTPS 部署建议等安全能力。当前说明为安全边界提示，不代表相关能力已经实现。部署前请先阅读 [部署安全边界](docs/deployment.md#部署安全边界)。
...
- [Release Notes](docs/release/v1.1.1-release-notes.md)
