...
v1.1.2 已补充单管理员初始化、登录 / 登出与管理端 Session 保护。OpenAPI Token、反向代理与 HTTPS 部署建议仍为后续独立能力。部署前请先阅读 [部署安全边界](docs/deployment.md#部署安全边界)。
...
- [Release Notes](docs/release/v1.1.2-release-notes.md)
