...
- [x] 文件信息查看与安全删除（v0.7.2，移动到音乐库 .music-vault-trash）
- [ ] 歌手/专辑/曲目元数据管理（规划中）
- [ ] 在线歌词抓取与多版本管理（规划中）
...
项目处于 **早期开发阶段**，后端 v0.1–v0.7.1 已完成，前端 v0.4–v0.7.1 已完成，核心功能陆续实现中。
...
|| v0.7.2 [✓] 文件信息与安全删除（移动到音乐库 .music-vault-trash）
|| v0.7.3 [ ] 管理后台 UI 体验优化（规划中）
